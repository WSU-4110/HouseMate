...
public class MyGridAdapter extends ArrayAdapter {
    ...
    List<CalendarContract.Events> eventsList;

    public MyGridAdapter(Context context, List<Date> dates, Calendar currentDate, List<CalendarContract.Events> eventsList) {
